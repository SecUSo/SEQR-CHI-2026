...
public class TutorialActivity extends AppCompatActivity {
    ...
    private void addBottomDots(int currentPage) {
        ...
        @ColorInt int colorActive = getResources().getColor(R.color.dot_light_screen, getTheme());
        @ColorInt int colorInactive = getResources().getColor(R.color.dot_dark_screen, getTheme());
